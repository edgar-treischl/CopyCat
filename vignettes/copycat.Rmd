...
And the `copycat_help()` function copies the examples section of a help file to your clipboard. Again, the `copycat_helpcode` function return only the code to see what we have copied.
